// pybind11 Python bindings for AgentHarness C++ Core
...
// ============================================================================
// Module: agent_harness_core
// ============================================================================

PYBIND11_MODULE(agent_harness_core, m) {
    m.doc() = "AgentHarness C++ Core — High-performance tools with memory safety";
