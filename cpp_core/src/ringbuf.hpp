// agent_harness_cpp_ringbuf -- lock-free single-producer single-consumer ring buffer.
//
...
// sequence counters.
//
// This is how AgentHarness hits <10ms tool-call latency — no malloc, no
...
namespace agent_harness_ringbuf {
