...
shape — but this implementation is **fresh and AgentHarness-native**; it does
...
class GatewayConfig:
    ...
    3. ``AgentHarness_*`` environment variables.
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "GatewayConfig":
        ...
        auth_token = str(data.get("auth_token", "") or os.getenv("AgentHarness_GATEWAY_TOKEN", ""))
    ...
    def from_sources(
        ...
        cfg.gateway.host = os.getenv("AgentHarness_GATEWAY_HOST", cfg.gateway.host)
        cfg.gateway.port = int(os.getenv("AgentHarness_GATEWAY_PORT", str(cfg.gateway.port)))
