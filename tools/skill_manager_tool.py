...
def _handle_skill_search(args: dict) -> str:
    """Search a skill catalog (default: AgentHarness's bundled starter catalog)."""
...
SKILL_SCHEMA = {
    ...
    "properties": {
        "action": {
            "type": "string",
            "enum": ["list", "view", "search", "install", "new", "hub"],
            "description": "Skill action: list installed, view detail, search hub, install, create new, or browse hub",
        },
        "name": {"type": "string", "description": "Skill name (for view/install/new)"},
        "query": {"type": "string", "description": "Search query (for search)"},
        "description": {"type": "string", "description": "Description (for new skill)"},
        "author": {"type": "string", "description": "Author (for new skill)"},
        "source": {"type": "string", "description": "Source URL/path (for install)"},
        "confirm": {"type": "boolean", "description": "Confirm install (for install)", "default": False},
...
def _handle_skill(args: dict) -> str:
    ...
    if action == "list":
        ...
        return _handle_skill_view(args)
    elif action == "search":
        return _handle_skill_search(args)
    elif action == "install":
        return _handle_skill_install(args)
    elif action == "new":
        return _handle_skill_new(args)
    elif action == "hub":
        return _handle_skills_hub(args)
