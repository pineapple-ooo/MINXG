...
MAX_DEPTH_DEFAULT = _env_int("AgentHarness_MAX_DEPTH", 8)
DEDUP_WINDOW_DEFAULT = _env_int("AgentHarness_DEDUP_WINDOW", 4)
COST_CEIL_MS_DEFAULT = _env_float("AgentHarness_COST_CEIL_MS", 30_000.0)
...
def _is_mobile_environment() -> bool:
    ...
    """
    if os.environ.get("AgentHarness_IS_MOBILE") == "1":
        return True
...
class CostGuard:
    ...
    Override via ``AgentHarness_COST_CEIL_MS`` on tight CI runners.
    """
