"""agent_harness.screen — Screen Perception & Action (SPA) system.
...
Quick start:
  from agent_harness.screen import ScreenController
...
# Screen module is auto-discovered via agent_harness/base.py WorkerRegistry and
