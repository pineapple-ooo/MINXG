...
class NetworkAdvWorker(BaseWorker):
    ...
    def _http_request(self, url: str, method: str = "GET", body: Dict = None,
        ...
        try:
            ...
            req_headers = {"User-Agent": "AgentHarness/1.0.0", "Accept": "*/*"}
            if headers:
    ...
    def _net_geoip(self, ip: str) -> Dict[str, Any]:
        try:
            ...
            req = Request(url, headers={"User-Agent": "AgentHarness/1.0.0"})
    ...
    def _net_speed_test(self, url: str = "https://speed.cloudflare.com/__down",
        ...
        try:
            ...
            t0 = time.time()
            req = Request(url + f"?bytes={size_kb * 1024}", headers={"User-Agent": "AgentHarness/1.0.0"})
    ...
    def _net_headers_analyze(self, url: str) -> Dict[str, Any]:
        try:
            req = Request(url, method="HEAD", headers={"User-Agent": "AgentHarness/1.0.0"})
