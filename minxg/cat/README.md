...
> Pillar 2 of 6 in AgentHarness. 79 operators in IDs 4000-4078.

Every operator in AgentHarness is a **morphism** in a category. Composition is
...
```python
from agent_harness.cat import Morphism, identity, compose
