# AgentHarness Architecture (v0.18.5)
...
## What even is AgentHarness?

AgentHarness is a polyglot AI agent platform. It runs in Python but has Rust doing the
...
Three rules make AgentHarness mechanically refactorable:
