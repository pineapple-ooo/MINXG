//! agent_harness_rust_core/src/math_ops.rs — complete linear algebra + statistics engine.
//!
//! This is the industrial-grade math backend for AgentHarness.  It replaces
