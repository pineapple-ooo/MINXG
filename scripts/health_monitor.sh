#!/bin/sh
# scripts/health_monitor.sh — AgentHarness health watchdog (docker cron)
#
...
# AgentHarness advantage: This is a 28-line sh script, not 180-line Python.

GATEWAY="http://agent_harness-gateway:8080"
ALERT_LOG="/data/health_alert.log"
MAX_FAILS=3
FAIL_FILE="/tmp/agent_harness_health_fails"
INTERVAL=60
