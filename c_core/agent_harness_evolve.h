/*
 * agent_harness_evolve.h — TIDAL LOCK ARCHITECTURE: Stable C ABI for Self-Evolution Core
 * ============================================================================
 *
 ...
 *
 * BUILD:
 *   gcc -std=c11 -O3 -fPIC -shared agent_harness_evolve.c mem_pool.c agent_harness_arch.c \
 *       -lxxhash -lzstd -lm -lpthread -o libagent_harness_evolve.so
 */

#ifndef AgentHarness_EVOLVE_H
#define AgentHarness_EVOLVE_H
...
#define AgentHarness_EVOLVE_ABI_VERSION 1
 ...
 *
 * Returns: AgentHarness_OK on success, AgentHarness_ERR_BUFFER_TOO_SMALL if output too small.
 */
...
#define AgentHarness_MINHASH_DIM 64
 ...
 */
double agent_harness_evolve_euclidean_v1(
 ...
 */
double agent_harness_evolve_cosine_v1(
    const double* a, const double* b, int dim
);
 ...
 */
double agent_harness_evolve_entropy_v1(
