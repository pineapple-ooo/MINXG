 ...
 * Provides: agent_harness_sha256, agent_harness_hmac_sha256, agent_harness_pbkdf2_sha256
 *           agent_harness_base64_encode, agent_harness_base64_decode
 *           agent_harness_compress, agent_harness_decompress, agent_harness_json_parse, agent_harness_data_hash
 */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
int64_t agent_harness_sha256(const uint8_t* in, size_t in_len, uint8_t* out, size_t out_cap) {
...
int64_t agent_harness_hmac_sha256(const uint8_t* key, size_t key_len,
...
int agent_harness_pbkdf2_sha256(const uint8_t* pass, size_t pass_len,
...
int64_t agent_harness_base64_encode(const uint8_t* in, size_t in_len,
                            uint8_t* out, size_t out_cap) {
    if (!in || !out) return -1;
...
int64_t agent_harness_base64_decode(const uint8_t* in, size_t in_len,
                            uint8_t* out, size_t out_cap) {
    if (!in || !out) return -1;
...
int64_t agent_harness_compress(const uint8_t* in, size_t in_len,
                       uint8_t* out, size_t* out_len) {
...
int64_t agent_harness_decompress(const uint8_t* in, size_t in_len,
                         uint8_t* out, size_t* out_len) {
...
bool agent_harness_json_parse(const char* json_str) {
...
uint64_t agent_harness_data_hash(const void* data, size_t len) {
