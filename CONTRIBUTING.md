# AgentHarness Contributing Guide

Thank you for your interest in contributing to AgentHarness!
...
git clone https://github.com/YOUR_USERNAME/AgentHarness-Beta.git
...
# Run with coverage
pytest tests/ --cov=agent_harness --cov=multiligua_cli --cov-report=html
...
```bash
# Check with ruff
ruff check agent_harness/ multiligua_cli/ tests/

# Format with ruff
ruff format agent_harness/ multiligua_cli/ tests/
```
...
def test_my_worker_basic():
    ...
    from agent_harness.workers.my_module import MyWorker
...
# Run with coverage
pytest tests/ --cov=agent_harness --cov-report=html
```
...
- Email: contributors@agent_harness.dev

Thank you for contributing to AgentHarness! 🚀
