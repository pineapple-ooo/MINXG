# AgentHarness TypeScript Gateway

Type-safe SDK + middleware for the AgentHarness OpenAI-compatible gateway.
...
```ts
import { AgentHarnessClient } from "@agent_harness/gateway-ts";

const client = new AgentHarnessClient({
