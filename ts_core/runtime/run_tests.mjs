#!/usr/bin/env node
/**
 * AgentHarness TypeScript Schema Validator Tests (JS port of src/validate.ts)
 *
...
console.log("AgentHarness TypeScript Schema Validator Tests (node only, no build)\n");
