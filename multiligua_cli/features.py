"""
multiligua_cli/features.py — AgentHarness Feature Showcase + EXPERIMENTAL extras
...
def print_selling_points(console=None) -> None:
    ...
    console.print(Panel(
        table,
        title="[bold gold3]◆  Why AgentHarness?[/bold gold3]",
        border_style="bright_blue",
        padding=(1, 2),
    ))
...
def share_to_gist(file_path: str, description: str = "AgentHarness conversation") -> str:
...
def welcome_animation():
    ...
    frames = [
        "\033[38;5;75m⚡ AgentHarness\033[0m",
        "\033[38;5;113m⚡ AgentHarness ·\033[0m",
        "\033[38;5;213m⚡ AgentHarness ··\033[0m",
        "\033[38;5;82m⚡ AgentHarness ···\033[0m",
    ]
    for frame in frames:
