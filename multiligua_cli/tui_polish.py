...
_USE_COLOR = sys.stdout.isatty() or os.environ.get("AgentHarness_COLOR") == "1"
...
def tool_call_card(name: str, args: Dict[str, Any],
    ...
    """Pretty-print a tool-call block — AgentHarness gold/teal high-density card.

    Pure ANSI (no Rich markup) so it is safe to cat into any TTY.
    """
