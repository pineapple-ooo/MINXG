"""
multiligua_cli/utils.py — Shared utilities for the AgentHarness CLI.
...
PROJECT_TAGLINE = "Five-pillar worker platform"
PROCESS_TITLE = "AgentHarness"
...
║                    ╚═╝     ╚═╝╚═╝╚═╝  ╚═══╝╚═╝  ╚═╝ ╚═════╝        ║
║                                                                      ║
║              AgentHarness — Multi-Language AI Orchestration                 ║
║                                                                      ║
║                           v{__version__}                                      ║
╚══════════════════════════════════════════════════════════════════════╝
"""
...
def set_process_title() -> None:
    ...
    try:
        ...
        if sys.platform == "linux":
            ...
            libc.prctl(15, PROCESS_TITLE.encode("utf-8"), 0, 0, 0)
        elif sys.platform == "darwin":
            libc = ctypes.CDLL("libc.dylib", use_errno=True)
            try:
                libc.prctl(15, PROCESS_TITLE.encode("utf-8"))
            except Exception:
                pass
    except Exception:
        pass
