"""
AgentHarness i18n — English-only (v0.18.x). All other locales removed per policy.
...
_DEFAULTS: Dict[str, str] = {
    ...
    # Branding & farewell
    "brand_full":           "AgentHarness — Five-Pillar Worker Platform",
    "brand_short":          "AgentHarness",
    "goodbye":              "Goodbye.",
    # Extensions
