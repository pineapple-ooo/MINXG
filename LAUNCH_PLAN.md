# AgentHarness MCP 发布计划

## 发布前检查清单

### 代码准备

- [x] MCP Server实现 (`agent_harness/mcp_server.py`)
- [x] Claude Code Skills (`.claude/skills/agent_harness/`)
...
- [ ] 仓库重命名：`AgentHarness-Beta` → `agent_harness-mcp`
- [ ] 更新仓库描述：`AgentHarness MCP — Connect Claude Code to 70+ AI Workers`
...
- [ ] 标题：`Show HN: AgentHarness MCP — 70+ AI Workers for Claude Code`
- [ ] 准备技术细节
- [ ] 准备好回复问题
