"""
AgentHarness Documentation Generator
"""
...
<head>
    ...
    <title>{% block title %}AgentHarness Documentation{% endblock %}</title>
...
<body>
    <div class="docs-container">
        ...
        <main class="content">
            ...
            <footer>
                <p>AgentHarness Documentation | Generated by Python Docs Generator</p>
                <p>Build: {{ build_date }} | <a href="https://github.com/agent_harness/agent_harness" target="_blank">GitHub</a></p>
            </footer>
        </main>
    </div>
...
class StaticAssetGenerator:
    ...
    def generate_css(self):
        css_content = """/* AgentHarness Documentation Styles */
:root {
...
"""
        ...
        js_content = """// AgentHarness Documentation JavaScript
...
async def main():
    import argparse
    parser = argparse.ArgumentParser(description="AgentHarness Documentation Generator")
