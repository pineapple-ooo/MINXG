...
import json
import time
from multiling.constants import (MAX_SESSIONS, ONE_MINUTE, DEFAULT_MAX_POINTS,
                                   HEALTH_HISTORY_LIMIT, ANALYTICS_EVENT_LIMIT)
import os
import threading
...
class HealthMonitor:
    ...
    def __init__(self):
        self._checks = {}
        self._status = {}
        self._history = deque(maxlen=HEALTH_HISTORY_LIMIT)
...
class UsageAnalytics:
    ...
    def __init__(self):
        self._events = deque(maxlen=ANALYTICS_EVENT_LIMIT)
        self._session_data = {}
        self._daily_stats = {}
